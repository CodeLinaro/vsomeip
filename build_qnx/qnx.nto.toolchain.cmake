...
if (${EXTRA_CMAKE_CXX_FLAGS} MATCHES "_QNX_IOSOCK")
	set(CMAKE_FIND_ROOT_PATH ${VSOMEIP_EXTERNAL_DEPS_INSTALL}/${CPUVARDIR}/io-sock;${VSOMEIP_EXTERNAL_DEPS_INSTALL};${VSOMEIP_EXTERNAL_DEPS_INSTALL}/${CPUVARDIR};${QNX_TARGET}/${CPUVARDIR}/io-sock;${QNX_TARGET};${QNX_TARGET}/${CPUVARDIR})
else()
